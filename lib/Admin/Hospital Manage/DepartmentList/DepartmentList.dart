...
class DepartmentList extends StatefulWidget {  @override
  State<StatefulWidget> createState() => DepartmentListState();
}
class DepartmentListState extends State {
  final DioClient _dioClient = DioClient();
  @override
  Widget build(BuildContext context) {
    return Scaffold(
     body: FutureBuilder<List<DepartmentListDatum>>(
                          ...
                          if(!snapshot.data!.isNotEmpty){
                            return Container();
                             ...
                             return Card(
                               ...
                               child: ListTile(
                                 title: Text(snapshot.data![index].departmentname,),
                                 leading: Text(snapshot.data![index].departmentId.toString(),style: GoogleFonts.oswald(),),
                                      ...
                                      return AlertDialog(
                                        ...
                                        actions: <Widget>[
                                          ...
                                          TextButton(onPressed: ()async{
                                            ...
                                            DeleteDepReq deleteDepReq_ = DeleteDepReq(
                                                DepartmentId: snapshot.data![index].departmentId.toString());
                                            DeleteDepResponse? retrievedUser= await _dioClient.DeleteDep(deleteDepReq: deleteDepReq_);
